...
#本月总销售额
Zsales = round((price1 * sales1 + price2 * sales2 +\
         price3 * sales3 + price4 * sales4 + \
         price5 * sales5 + price6 * sales6 + price7 * sales7 +\
         price8 * sales8 + price9 * sales9 + price10 * sales10 + \
         price11 * sales11 + price12 * sales12 + price13 * sales13 + \
         price14 * sales14 + price15 * sales15 + price16 * sales16 + \
         price17 * sales17 + price18 * sales18 + price19 * sales19 +
price20 * sales20 + price21 * sales21 + price22 * sales22 + \
price23 * sales23 + price24 * sales24 + price25 * sales25 + \
price26 * sales26 + price27 * sales27 + price28 * sales28 + price29 * sales29 + price30 * sales30),2)

#本月总销售服装件数
JSsales = sales1 + sales2 + sales3 + sales4 + sales5 + sales6 + sales7 + sales8 \
          + sales9 + sales10 + sales11 + sales12 + sales13 + sales14 + sales15 + \
          sales16 + sales17 + sales18 + sales19 + sales20 + sales21 + sales22 + sales23 +\
          sales24 + sales25 + sales26 + sales27 + sales28 + sales29 + sales30
